...
static UINavigationController *downNavCtl = nil;

@interface MenuTableViewController ()
{
    NSMutableArray *_menuArray;
}
//@property (nonatomic, strong) DownloadTableViewController *downViewController;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        if (downNavCtl == nil) {
            DownViewController *downViewController = [[DownViewController alloc]init];
            downNavCtl = [[UINavigationController alloc]initWithRootViewController:downViewController];
        }
        [self presentViewController:downNavCtl animated:YES completion:nil];
    }
